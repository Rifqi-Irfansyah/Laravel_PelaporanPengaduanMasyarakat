...
<nav class="bg-gray-700 fixed w-full z-30 px-24 rounded-b-3xl">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="/" class="bg-gray-900 text-white rounded-3xl px-3 py-2 text-sm font-medium"
                            aria-current="page">Dashboard</a>

                        <a href="#"
                            class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-3xl px-3 py-2 text-sm font-medium">Team</a>

                        <a href="#"
                            class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-3xl px-3 py-2 text-sm font-medium">Projects</a>

                        <a href="#"
                            class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-3xl px-3 py-2 text-sm font-medium">Calendar</a>
                    </div>
                </div>
            </div>
          ...
          -->
                    <div class="absolute hidden lg:hidden right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black lg:block ring-opacity-5 focus:outline-none "
