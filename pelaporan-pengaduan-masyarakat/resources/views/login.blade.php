...
<body>
                ...
                <div class="sm:flex sm:items-start">
                    <div
                        ...
                        <svg class="h-6 w-6 text-red-600" stroke="currentColor" fill="none" viewBox="0 0 23 20">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12.707 10l4.647-4.646a.5.5 0 0 0-.708-.708L12 9.293l-4.646-4.647a.5.5 0 0 0-.708.708L11.293 10l-4.647 4.646a.5.5 0 0 0 .708.708L12 10.707l4.646 4.647a.5.5 0 0 0 .708-.708L12.707 10z">
                            </path>
                        </svg>
                    </div>
    ...
    <h1 class="text-3xl font-bold text-middle">
        <section class="bg-gray-50 min-h-screen flex items-center justify-center">
            <!-- login container -->
            <div class="bg-light flex rounded-3xl shadow-lg max-w-2xl p-5 items-center">
                <!-- form -->
                <div class="md:w-1/2 px-8 md:px-14">
                    ...
                    <form action="{{ route('loginaksi') }}" method="post" class="flex flex-col gap-4 text-xs">
                        @csrf
                        ...
                        <button class="bg-dark rounded-xl text-white py-2 hover:scale-105 duration-300">Login</button>
                    </form>
                    ...
                    <div class="mt-5 text-xs flex justify-between items-center">
                        ...
                        <button
                            class="py-2 px-5 bg-white text-dark border rounded-xl hover:scale-110 duration-300">Register</button>
                    </div>
                </div>

                <!-- animate -->
                <div class="md:block hidden w-1/2">
                    <img class="rounded-3xl" src="{{ asset('images/animate_login.gif') }}">
                </div>
            </div>
        </section>
    </h1>
